    ...
    <div class="wrap">
      <div id="login-box" class="login-box">
        ...
        <div id="id-login" class="form-box">
          ...
          <a class="change" href="javascript:changeLogin('1');">CA证书登录 &gt;&gt;</a>
        </div>
        <%--<%--%>
          <%--}--%>
          <%--else--%>
        ...
        <div id="ca-login" class="form-box">
          ...
          <div class="input-bg" style="margin:10px 0 50px;">
            <label>密码：</label>
            <i class="lock"></i>
            <section class="row">
                <%--
          ...
          <input class="btn" accesskey="l" value="CA证书登录" tabindex="4" type="button" onclick="auth();" style="border: none;margin-bottom:25px;" />
          <a class="change" href="javascript:changeLogin('2');">帐号密码登录 &gt;&gt;</a>
        </div>
        <%--<%--%>
          <%--}--%>
        <%--%>--%>
